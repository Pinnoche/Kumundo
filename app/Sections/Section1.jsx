...
//         <div className="flex flex-col lg:items-start pt-8 lg:pt-28 sm:items-center w-full lg:w-1/2 font-kanit">
...
//           </p>
//           <div className="mt-10 flex justify-center sm:flex-col md:flex-row lg:justify-start space-x-4">
//             <button className="px-4 py-2 bg-blue-600 rounded-xl  hover:shadow-lg text-2xl hover:shadow-white">
//               Buy Now
//             </button>
//             <button className="bg-white text-black py-2 px-4 text-2xl rounded-xl">
//               Chart
//             </button>
//           </div>
//         </div>
